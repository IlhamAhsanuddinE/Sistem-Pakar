...
<style>
  ...
  .btn-custom {
  background-color: #296274 !important;
  color: white;
  }
</style>
</head>
...
<body class="">
  <div class="container position-sticky z-index-sticky top-0">
    <div class="row">
      <div class="col-12">
        <!-- Navbar -->
        <nav class="navbar bg-custom navbar-expand-lg  border-radius-lg top-0 z-index-3 lg:position-absolute mt-4 py-2 start-0 end-0 mx-4">
                ...
                <div class="card-body">
                  <form method="post" role="form">
                    ...
                    <div class="text-center">
                      <button type="button" id="submit" class="btn btn-lg btn-custom btn-lg w-100 mt-4 mb-0 text-white">Daftar</button>
                    </div>
                  </form>
                </div>
